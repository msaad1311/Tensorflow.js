...
function backer(t) {
  console.log('hello'); // const bgs = document.getElementById(id);
}
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            backgroundDarkeningMask = bodyPix.toMask(segmentation, foregroundColor, backgroundColor, false); // if (!(blurEffect && grayEffect)){
            ...
            effect_blur.addEventListener('change', function () {
              if (effect_blur.checked) {
                blurEffect = true;
                frameMerger(backgroundDarkeningMask, blurEffect, grayEffect); // console.log('it is on');
                // console.log(grayEffect);
              } else {
                blurEffect = false;
                frameMerger(backgroundDarkeningMask, blurEffect, grayEffect); // console.log('it is off');
                // console.log(grayEffect);
              }
            });
